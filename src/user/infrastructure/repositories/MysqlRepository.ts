...
export class MysqlUserRepository implements UserRepository {
    ...
    async save(user: User): Promise<User | null> {
        ...
        let sql = `INSERT INTO users (id,uuid,username, email, password, status) VALUES (?,?,?,?,?,?)`;
        let params = [user.id, user.uuid,user.username, user.email, user.password, user.status];
